...
public class History {
	...
	private static int historySize = LinKlipboard.HISTORY_DEFAULT;; // 사용자가 원하는
																	// 히스토리 크기
																	// // 도연 수정
	...
	/**
	 * 전달받은 latestContents를 Vector<Contents>에 넣고 Contents의 타입이 이미지 이면 Vector
	 * <ImageIcon> 에 resizing된 이미지를 넣음
	 * 
	...
	// public void setVector(Vector<Contents> sharedContents, Vector<ImageIcon>
	// resizingImgContents) {
